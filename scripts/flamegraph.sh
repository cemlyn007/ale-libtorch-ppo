...
sudo perf record -b -g --output=$perf_file_path $workspace/bazel-bin/src/bin/ale_ppo_threaded $workspace/roms/breakout.bin $workspace/logs/perf $workspace/images/perf perf $workspace/configs/v2.yaml || true
trap - SIGINT
